...
import com.cloudconnections.utility.CloudConnectStatus;
import com.cloudconnections.utility.CloudFileWritter;
import com.cloudconnections.utility.ErrorHandler;
import com.cloudconnections.utility.Logger;
import com.cloudconnections.utility.Utility;
 ...
 */
public class HttpMethod extends AsyncTask<Integer, Void, String> {
    ...
    public HttpMethod(Context mContext, CloudAPICallback callback) {
    ...
    protected void onPreExecute() {
        String data = "===========================================";
        CloudFileWritter.writeToFile(data);

        try {
            String url = getUrl().toString();
            CloudFileWritter.writeToFile(url);
        ...
        if (TextUtils.isEmpty(response)) {
            ...
            try {
                if (callback != null) {
                    ...
                    CloudFileWritter.writeToFile(response);
